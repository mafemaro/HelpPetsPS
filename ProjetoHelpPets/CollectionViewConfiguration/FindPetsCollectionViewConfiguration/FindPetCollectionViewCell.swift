...
class FindPetCollectionViewCell: UICollectionViewCell {
    
    static let identifier: String = "FindPetsViewCell"
    
    let customView: FindPetsCustomView = {
        let view = FindPetsCustomView()
